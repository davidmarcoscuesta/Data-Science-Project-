...
#SM# nice work in defining a separate function to clean the data
...
#SM# this comment is a little confusing! using what "function"? I think you could simply say "reading data".

master_file <- read.csv('C:/My stuff/Data Science 1/David_DataSci_Project_CodeReview/data/master_file_01.csv') %>% 
...
#SM# the rest of this chunk looks great!
...
#SM# I think more clarification here is needed!
...
```{r}
df_word_freq <- read_excel('C:/My stuff/Data Science 1/David_DataSci_Project_CodeReview/data/wordFrequency60k.xlsx', sheet = 'lemmas')  %>% 
...
#SM# good job in giving proper names to datasets
```
...
#SM# I personally didn't find the following plot super-informative!
...
#SM# are there other ways to visualize this? It's difficult to follow for me!
```
